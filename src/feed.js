...
export function cartsShape(feed) {
  return feed.games.map((g) => ({ s: g.slug, n: g.name, u: g.url, a: g.shell, plate: g.plate, rank: g.rank, plays: g.plays.week, playsBy: g.plays.by, visitors: g.plays.d7, category: g.category, family: g.family, variant: g.variant || undefined }));
}
