...
<style>html{overflow-x:clip}body{margin:0;background:#1c1a17;color:#e8e2d8;font:16px/1.5 ui-monospace,Menlo,monospace;padding:32px 20px}main{max-width:1100px;margin:0 auto}h1{font-size:20px;margin:0 0 4px}p{color:#9a9184;margin:0 0 16px}
#cab{--w:min(100vw,calc(94vh * 820 / 700));position:relative;width:var(--w);aspect-ratio:820/700;left:50%;margin:-32px 0 28px calc(var(--w) / -2)}
#cab>img{position:absolute;inset:0;width:100%;height:100%;pointer-events:none;-webkit-mask-image:linear-gradient(#000 86%,transparent);mask-image:linear-gradient(#000 86%,transparent)}
#intro{position:absolute;left:15.7%;top:19.5%;width:68.7%;height:58%;padding:0;border:0;background:#000;cursor:pointer;overflow:hidden}
...
<body><div id="cab"><button id="intro" aria-label="Play: Come see my arcade"><img src="/intro.jpg" alt=""><i></i></button><img src="/cabinet.webp" alt=""><img src="/cabinet-glass.webp" alt=""></div>
<main><nav class="pages" aria-label="Pages"><a href="/" aria-current="page">Games</a><a href="/resources">Resources</a></nav><h1>Big Head Club arcade</h1>
...
(function () {
  ...
  intro.addEventListener('click', function () {
    ...
    intro.innerHTML = '<iframe src="https://www.youtube-nocookie.com/embed/6X80OHYLnjg?autoplay=1&rel=0" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen title="Come see my arcade. It&#39;s fun."></iframe>';
